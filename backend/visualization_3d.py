...
def _build_platform_js(geometry_json):
    ...
    return (
        ...
        '        }\n'
        '    }\n'
        '    t.push(disc(0,0,-80,150,"#22c55e","300mm Wafer"));\n'
        '    t.push(box(0,0,-95,340,340,10,"#64748b","XY Stage","Sub-nm positioning",0.25));\n'
        '    t.push({type:"scatter3d",x:[pw/2+40],y:[0],z:[ph/2],mode:"text",\n'
        '        text:["<b>Integrated Platform</b><br>"+P.total_heads+" writer heads<br>"+\n'
        ...
        '        text:["<b>300 mm Wafer</b><br>All "+P.total_heads+" heads expose in parallel"],\n'
        ...
        '                mode:"lines",line:{color:"rgba(139,92,246,0.5)",width:2},\n'
        '                hoverinfo:"skip",showlegend:false});\n'
        '            t.push({type:"scatter3d",\n'
        '                x:[hx],y:[hy],z:[-25],mode:"markers",\n'
        '                marker:{size:4,color:"#22c55e",symbol:"circle"},\n'
        '                hovertext:"Exposure field, Head "+(idx+1),hoverinfo:"text",showlegend:false});\n'
        '        }\n'
        '    }\n'
        '    t.push(disc(0,0,-26,pkgSize*0.6,"#22c55e","Wafer Surface"));\n'
        ...
        '    t.push({type:"scatter3d",x:[pkgSize/2+8],y:[0],z:[2],mode:"text",\n'
        '        text:["<b>33\\u00d733 mm Package</b><br>4\\u00d74 = 16 writer heads<br>"+\n'
        '              "Flip-chip on Si interposer<br>Batch fabricated"],\n'
        '        textfont:{size:11,color:"#ea580c"},hoverinfo:"skip",showlegend:false});\n'
        '    t.push({type:"scatter3d",x:[0],y:[0],z:[-32],mode:"text",\n'
        '        text:["<b>16 parallel beams</b><br>Each head: independent 11-DOF control"],\n'
        ...
        '     title:"Integrated Multi-Head Writer Platform (160 heads, desk-sized)",\n'
        '     margin:{t:50,b:20,l:0,r:0}},\n'
        '    {scene:{xaxis:{title:"X (mm)",range:[-30,45],showgrid:true,gridcolor:"#eee"},\n'
        '            yaxis:{title:"Y (mm)",range:[-25,25],showgrid:true,gridcolor:"#eee"},\n'
        '            zaxis:{title:"Z (mm)",range:[-35,15],showgrid:true,gridcolor:"#eee"},\n'
        '            aspectmode:"manual",aspectratio:{x:1.5,y:1.0,z:1.0},\n'
        '            camera:cameras[1],bgcolor:"#fafafa"},\n'
        '     height:780,width:1400,showlegend:true,\n'
        '     legend:{x:0.01,y:0.99,bgcolor:"rgba(255,255,255,0.8)"},\n'
        '     title:"33\\u00d733 mm Package \\u2014 4\\u00d74 Writer Head Array",\n'
        '     margin:{t:50,b:20,l:0,r:0}},\n'
